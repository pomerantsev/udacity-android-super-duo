...
public class MainActivity extends ActionBarActivity
{
    ...
    private static final String MAIN_KEY = "my_main";
    ...
    protected void onSaveInstanceState(Bundle outState)
    {
        ...
        outState.putInt(
                PAGER_CURRENT_KEY,my_main.mPagerHandler.getCurrentItem());
        outState.putInt(SELECTED_MATCH_KEY,selected_match_id);
        getSupportFragmentManager().putFragment(outState,MAIN_KEY,my_main);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState)
    {
        ...
        my_main = (PagerFragment) getSupportFragmentManager().getFragment(savedInstanceState,MAIN_KEY);
